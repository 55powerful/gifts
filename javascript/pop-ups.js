$(document).ready(function() {
    ...
    document.querySelector(".literature-question-button").addEventListener('click', function() {
        Swal.fire({
            title: 'Literature Section Information',
            html: 'This is the Literature section. For the Harry Potter Series, I am looking for a complete box set(holder), hard covered books with the original covers.',
            footer: 'Only purchase if items are on sale. Item prices fluctuate constantly! Skip the expensive purchases and come back because they might be on sale then. Or as time goes by, items may become cheaper!',
            backdrop: "rgb(0,0,0,0.9)",
            // background: '#FF8700',
            width: '95%',
