...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $('.container-slides').flickity({
            ...
            // groupCells: true // Groups cells with best positioning
...
if (matchMedia('screen and (max-width: 1100px)').matches) {
    ...
    options_container_3.contain = true;
    options_container_3.groupCells = true;
    options_container_3.pageDots = true;
...
if (matchMedia('screen and (max-width: 1100px)').matches) {
    ...
    options_container_4.contain = true;
    options_container_4.groupCells = true;
    options_container_4.pageDots = true;
...
if (matchMedia('screen and (max-width: 700px)').matches) {
    ...
    options_container_5.contain = true;
    options_container_5.groupCells = true;
    options_container_5.pageDots = true;
